...
- Fixed generated-agent prompt guidance to reference AGENTS.md/current context files instead of CLAUDE.md, and fixed eager todo guidance to use supported todo fields.
