...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/capability/routine",
	...
	"@oh-my-pi/pi-coding-agent/commands/system-prompt",
	...
	"@oh-my-pi/pi-coding-agent/discovery/routines",
	...
	"@oh-my-pi/pi-coding-agent/extensibility/routines",
