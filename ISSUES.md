...
| [ISSUE-009](issues/ISSUE-009.md) | Read SSH guidance: retired search and ssh tool names remain model-visible | Implementing | Pull request | New pull request | Medium | Push SSH guidance PR | Not published. |
