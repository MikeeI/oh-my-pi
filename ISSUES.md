...
| [ISSUE-011](issues/ISSUE-011.md) | Read: compact directory metadata spacing | Submitted | Pull-Request-Implementation | New-pull-request | Medium | Rebase Read PR branch | https://github.com/can1357/oh-my-pi/pull/9062 |
| [ISSUE-012](issues/ISSUE-012.md) | Prompt: metadata-free workspace tree | Submitted | Pull-Request-Implementation | New-pull-request | Medium | Rebase tree PR branch | https://github.com/can1357/oh-my-pi/pull/9152 |
