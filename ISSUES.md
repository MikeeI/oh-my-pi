...
| [ISSUE-009](issues/ISSUE-009.md) | Read SSH guidance: retired search and ssh tool names remain model-visible | Ready | Pull request | New pull request | Medium | Approve SSH guidance PR | Not published. |
